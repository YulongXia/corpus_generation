...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = open('data/corpus.pairs.txt', encoding='utf-8').\
        read().strip().split('\n')
...
input_lang, output_lang, pairs = prepareData('expr1', 'expr2', False)
...
if predict == True:
    ...
    with open('attn_decoder1.pkl', 'rb') as f:
    ...
    for row in range(1,rows):
        ...
        output_words, attentions = evaluate(
            encoder1, attn_decoder1, sentence.lower())

        print(sentence,"".join(output_words),sep="####")
    exit()
...
with open('attn_decoder1.pkl', 'wb') as f:
